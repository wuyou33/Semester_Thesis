...
data = genfromtxt('csv_data/data_1901.csv', delimiter=',', skip_header=1)
...
# Filtering
b, a = signal.butter(2, 15/(sf/2), 'low', analog=False)
...
accel_f = accel_f.reshape((accel_f.shape[0],1))
