...
%
% TODOs:
% - Write instructions (what and where to fill in)
%
% - References 
% - Style of the List of Symbols
...
% Package for setting space between units in TOC, LOF...
...
% Add Table of Acronyms 
\chapter*{Table of Acronyms} \label{sec:acronyms}
\textbf{Acronym}\hspace{3.3cm}\textbf{Description}
\vspace*{-2mm}	% vertical space 
\begin{acronym}[ADF\hspace{4cm}]\itemsep=0pt 	% in [] supposed to be the largest word
	\acro{ADF}{Automatic Direction Finder}
	\acro{ADI}{Automatic Direction Indicator}
\end{acronym}
