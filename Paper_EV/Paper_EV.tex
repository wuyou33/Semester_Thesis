...
\begin{equation}
	...
	\end{split}
\end{equation}
where $I_{rzz}$ is the element of the inertia matrix $I_{r}$ of the rotor, $l$ and $b$ lever arms as denoted in the Figure (TODO:Figure), $k_F$ and $k_M$ force and moment constants of the rotors.
...
TODOs: \\
- 2.1   Source (Probably Holzapfel script) \\
