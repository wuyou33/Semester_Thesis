...
The Crazyflie's main application \acrfull{MCU} is STM32F405. It runs the firmware with frequency of $1000~\si{\Hz}$ and communicates with a large number of peripheral devices such as Bluetooth and long range radio, power management system \acrshort{MCU}, \acrfull{IMU} etc.. The \acrfull{IMU} consists of the 3-axis accelerometer, the 3-axis gyroscope and the high precision pressure sensor. 
