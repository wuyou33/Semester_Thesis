...
\mbox{}
\nomwithdim{B, 001}{\( A(s),~A(z) \)}{Transfer function of the actuator dynamics}{}{--}
\nomwithdim{B, 002}{\( A'(s),~A'(z) \)}{Transfer function of the actuator dynamics model}{}{--}
...
\nomwithdim{B, 025}{\( \bm{G} \)}{Control effectiveness matrix of the outer loop}{}{--}
\nomwithdim{B, 025}{\( \bm{G}_1 \)}{Control effectiveness matrix of the inner loop}{}{--}
\nomwithdim{B, 025}{\( \bm{G}_2 \)}{Control effectiveness matrix of the inner loop}{}{--}
\nomwithdim{B, 025}{\( \bm{G}_{inner} \)}{Dynamics matrix of the inner loop}{}{--}
\nomwithdim{B, 025}{\( \bm{G}_{outer} \)}{Dynamics matrix of the outer loop}{}{--}
\nomwithdim{B, 025}{\( \bm{G}(x) \)}{Input matrix}{}{--}
...
\nomwithdim{B, 052}{\( m \)}{Mass of the quadrotor}{}{$kg$}
\nomwithdim{B, 052}{\( m_{cf} \)}{Mass of the Crazyflie quadrotor}{}{$kg$}
...
\nomwithdim{B, 080}{\( T \)}{Thrust}{}{$N$}
\nomwithdim{B, 080}{\( T \)}{Time constant of the actuator dynamics}{}{$s$}
\nomwithdim{B, 080}{\( T_{cmd} \)}{Thrust in motor units}{}{--}
\nomwithdim{B, 080}{\( T_s \)}{Sample time of the controller}{}{$s$}
\nomwithdim{B, 081}{\( \tilde{T} \)}{Thrust increment}{}{$N$}
\nomwithdim{B, 081}{\( t \)}{Time}{}{$s$}
\nomwithdim{B, 085}{\( \bm{u} \)}{Input vector}{}{--}
\nomwithdim{B, 085}{\( \bm{u}_c \)}{Control vector}{}{--}
\nomwithdim{B, 085}{\( u \)}{$x$-component of the velocity vector}{}{$m/s$}
\nomwithdim{B, 090}{\( V \)}{Component of the velocity vector}{}{$m/s$}
\nomwithdim{B, 091}{\( v \)}{$y$-component of the velocity vector}{}{$m/s$}
\nomwithdim{B, 091}{\( \bm{v} \)}{Velocity vector}{}{$m/s$}
\nomwithdim{B, 095}{\( W \)}{Weight of the quadrotor}{}{$N$}
\nomwithdim{B, 095}{\( w \)}{$z$-component of the velocity vector}{}{$m/s$}
\nomwithdim{B, 100}{\( \bm{x} \)}{State vector}{}{--}
\nomwithdim{B, 100}{\( x \)}{Position coordinate in $x$-direction}{}{$m$}
\nomwithdim{B, 105}{\( \bm{y} \)}{Output vector}{}{--}
\nomwithdim{B, 105}{\( y \)}{Position coordinate in $y$-direction}{}{$m$}
\nomwithdim{B, 110}{\( \bm{z} \)}{Transformed state vector}{}{--}
\nomwithdim{B, 110}{\( z \)}{z-Transformation variable}{}{--}
\nomwithdim{B, 110}{\( z \)}{Position coordinate in $z$-direction}{}{$m$}

\nomwithdim{G, 200}{\( \alpha \)}{Parameter of the discrete first order lag element}{}{$N$}
\nomwithdim{G, 205}{\( \zeta \)}{Relative damping coefficient of the second order filter}{}{--}
\nomwithdim{G, 206}{\( \bm{\eta} \)}{Attitude vector}{}{$rad$}
\nomwithdim{G, 210}{\( \Theta \)}{Pitch angle}{}{$rad$}
\nomwithdim{G, 210}{\( \tilde{\Theta} \)}{Pitch angle increment}{}{$rad$}
\nomwithdim{G, 210}{\( \Theta_c \)}{Control pitch angle}{}{$rad$}
\nomwithdim{G, 215}{\( \bm{\nu} \)}{Virtual control input vector}{}{--}
\nomwithdim{G, 215}{\( \bm{\nu}_{\bm{\dot{v}}} \)}{Virtual control input vector of the outer loop}{}{$m/s^2$}
\nomwithdim{G, 215}{\( \bm{\nu}_{\bm{\dot{\omega}}} \)}{Virtual control input vector of the inner loop}{}{$rad/s^2$}
\nomwithdim{G, 219}{\( \bm{\xi} \)}{Position vector}{}{$m$}
\nomwithdim{G, 220}{\( \Phi \)}{Roll/Bank angle}{}{$rad$}
\nomwithdim{G, 220}{\( \tilde{\Phi} \)}{Roll angle increment}{}{$rad$}
\nomwithdim{G, 220}{\( \Phi_c \)}{Control roll angle}{}{$rad$}
\nomwithdim{G, 221}{\( \bm{\phi}(\bm{x}) \)}{State transformation function}{}{--}
\nomwithdim{G, 225}{\( \bm{\chi} \)}{Wind vector}{}{$m/s$}
\nomwithdim{G, 230}{\( \Psi \)}{Yaw/Bank angle}{}{$rad$}
\nomwithdim{G, 235}{\( \bm{\Omega} \)}{Propeller rate vector of the four rotors}{}{$rad/s$}
\nomwithdim{G, 235}{\( \bm{\Omega}_i \)}{Propeller rate of the i-th rotor}{}{$rad/s$}
\nomwithdim{G, 235}{\( \tilde{\bm{\Omega}} \)}{Propeller rate increment}{}{$rad/s$}
\nomwithdim{G, 235}{\( \bm{\Omega}_c \)}{Propeller rate control vector of the four rotors around}{}{$rad/s$}
\nomwithdim{G, 236}{\( \bm{\omega} \)}{Angular velocity vector of the quadrotor}{}{$rad/s$}
\nomwithdim{G, 236}{\( \omega_n \)}{Cutoff frequency of the second order filter}{}{$rad/s$}

\nomwithdim{S}{\( 0 \)}{Initial point in time}{}{--}
\nomwithdim{S}{\( a \)}{Passed through the actuator dynamics}{}{--}
\nomwithdim{S}{\( B \)}{Body-fixed coordinate frame}{}{--}
\nomwithdim{S}{\( D \)}{Down}{}{--}
\nomwithdim{S}{\( E \)}{East}{}{--}
\nomwithdim{S}{\( f \)}{Filtered}{}{--}
\nomwithdim{S}{\( G \)}{Center of gravity}{}{--}
\nomwithdim{S}{\( G \)}{Gravitational}{}{--}
\nomwithdim{S}{\( K \)}{Kinematic coordinate frame}{}{--}
\nomwithdim{S}{\( N \)}{North}{}{--}
\nomwithdim{S}{\( O \)}{North-East-Down coordinate frame}{}{--}
\nomwithdim{S}{\( R \)}{Reference point}{}{--}
\nomwithdim{S}{\( x \)}{$x$-component of a variable}{}{--}
\nomwithdim{S}{\( y \)}{$y$-component of a variable}{}{--}
\nomwithdim{S}{\( z \)}{$z$-component of a variable}{}{--}

\nomwithdim{X, 400}{\( L \)}{Lie derivative operator}{}{--}
\nomwithdim{X, 401}{\( \nabla \)}{Nabla-Operator}{}{--}
...
\begin{figure}[H]
	...
	\begin{tikzpicture}
		\node[inner sep=0pt] (crazyflie_drone) at (0,0) {
		\includegraphics[width=0.85\textwidth]{figs/sim_outer_all.pdf}};
	\end{tikzpicture}
	% Figure description is centered aligned
	\captionsetup{justification=centering, singlelinecheck=off, font=bf, belowskip=-0.5cm}
...
\begin{figure}[H]
	...
	\begin{tikzpicture}
		\node[inner sep=0pt] (crazyflie_drone) at (0,0) {
		\includegraphics[width=0.85\textwidth]{figs/sim_inner_all.pdf}};
	\end{tikzpicture}
	% Figure description is centered aligned
	\captionsetup{justification=centering, singlelinecheck=off, font=bf, belowskip=-0.5cm}
